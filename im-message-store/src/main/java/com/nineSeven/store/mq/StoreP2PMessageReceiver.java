...
public class StoreP2PMessageReceiver {
    ...
    @RabbitListener(bindings = @QueueBinding(value = @Queue(value = Constants.RabbitConstants.StoreP2PMessage, durable = "true"),
            exchange = @Exchange(value = Constants.RabbitConstants.StoreP2PMessage)),concurrency = "1")
    public void onChatMessage(@Payload Message message, @Headers Map<String,Object> headers, Channel channel) throws Exception {
        ...
        try {
            ...
            dto.setImMessageBodyEntity(jsonObject.getObject("messageBody", ImMessageBodyEntity.class));
            storeMessageService.storeP2PMessage(dto);
